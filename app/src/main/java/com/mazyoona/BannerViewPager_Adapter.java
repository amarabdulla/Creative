...
//        Picasso.with(context).load(IMAGES.get(position)).placeholder(R.drawable.banner_stub_loading).noFade().into(imageView);
        Glide.with(context)
                .load(IMAGES.get(position))
                .placeholder(R.drawable.banner_stub_loading)
                .error(R.drawable.banner_stub_error)
                .into(imageView);
