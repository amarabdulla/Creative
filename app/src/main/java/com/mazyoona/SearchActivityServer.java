...
/**
 * Created by Creative on 19-Oct-16.
 */
public class SearchActivityServer extends Activity implements  View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.search_layout_server);
        ...
        mCustomProgressDialog = new CustomProgressDialog(SearchActivityServer.this);
...
//        bottomNavigation.setColored(true);
        ...
        bottomNavigation.setOnTabSelectedListener(new AHBottomNavigation.OnTabSelectedListener() {
            ...
            public void onTabSelected(int position, boolean wasSelected) {
                switch (position) {
                    case 0:
                        Intent intent= new Intent(SearchActivityServer.this,HomePage.class);
                        startActivity(intent);
                        SearchActivityServer.this.finish();
                        break;
                    case 1:
                        break;
                    case 2:
                        Intent intent2= new Intent(SearchActivityServer.this,SearchActivityServer.class);
                        startActivity(intent2);
                        SearchActivityServer.this.finish();
                        break;
                    case 3:
                        if (!ShoppingCart.product_names.isEmpty()){
                            Intent scart = new Intent(SearchActivityServer.this, ShoppingCart.class);
                            startActivity(scart);
                            mDrawerLayout.closeDrawer(GravityCompat.END);
                        }else {
                            Intent scart = new Intent(SearchActivityServer.this, LoginEmptyCartActivity.class);
                            startActivity(scart);
                            mDrawerLayout.closeDrawer(GravityCompat.END);
                        }
                        break;
                    case 4:
                        if (Activity_Login.username.equals("") || Activity_Login.username.equals("temp")){
//                            initAlertDialog();
                            new SweetAlertDialog(SearchActivityServer.this, SweetAlertDialog.NORMAL_TYPE)
                                    .setTitleText("Please login to continue")
                                    .setConfirmText("OK")
                                    .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                        @Override
                                        public void onClick(SweetAlertDialog sweetAlertDialog) {
                                            Intent intent = new Intent(SearchActivityServer.this,Activity_Login.class);
                                            startActivity(intent);
                            ...
                            Intent intent4 = new Intent(SearchActivityServer.this, ProfilePage.class);
        ...
        init_navigator();
        search_edittext.addTextChangedListener(new DelayedTextWatcher(1000) {
            ...
            public void afterTextChangedDelayed(Editable s) {
                ...
                search_url=HomePage.FIRSTPART+"products?text="+search_edittext.getText().toString();
...
//                no_search_result.setVisibility(View.GONE);
        ...
        if (AppStatus.getInstance(this).isOnline()) {
            ...
            new SweetAlertDialog(SearchActivityServer.this, SweetAlertDialog.WARNING_TYPE)
...
//            dialog.show();
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            gridViewAdapter = new GridViewAdapter(SearchActivityServer.this, imagesParseArray,imageLargeArray, titleParseArray,
...
//            }
//            //Creating GridViewAdapter Object
//            GridViewAdapter gridViewAdapter = new GridViewAdapter(SearchActivityServer.this, imagesParseArray,imageLargeArray, titleParseArray,
//                    sale_priceParseArray,purchase_priceParseArray,designer_nameParseArray,
//                    avaliablilityParseArray,qtyArray,discountParseArray,productIdArray,descArray);
//
//            //Adding adapter to gridview
        ...
        protected Boolean doInBackground(final String... args) {
            ...
            try {
                ...
                if (!jsonObject.isNull("products")) {
                    titleParseArray.clear();
                    imagesParseArray.clear();
                    imageLargeArray.clear();
                    sale_priceParseArray.clear();
                    purchase_priceParseArray.clear();
                    designer_nameParseArray.clear();
                    avaliablilityParseArray.clear();
                    discountParseArray.clear();
