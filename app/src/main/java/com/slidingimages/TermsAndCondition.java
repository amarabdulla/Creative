 ...
 */
public class TermsAndCondition extends ActionBarActivity implements View.OnClickListener{
    private static final String name = "name";
    String namepref;
    private WebView webview;
    private static final String TAG = "Main";
    private ProgressDialog progressBar;
    private static String URL=HomePage.FIRSTPART+"page/t_c";
...
//        webview.setScrollBarStyle(WebView.SCROLLBARS_OUTSIDE_OVERLAY);
        ...
        progressBar = ProgressDialog.show(TermsAndCondition.this, "", "Please wait..");
