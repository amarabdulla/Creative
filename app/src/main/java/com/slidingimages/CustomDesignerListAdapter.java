...
/**
 * Created by Creative on 07-Sep-16.
 */
public class CustomDesignerListAdapter extends BaseAdapter  {
    ...
    public CustomDesignerListAdapter(Activity a, ArrayList<String> images, ArrayList<String> title, ArrayList<String> companyArray,
